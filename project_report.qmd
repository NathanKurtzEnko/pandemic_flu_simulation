...
This analysis is done using the R programming language, and relies on tools and data from Epiverse-TRACE, a framework of packages in the R programming language dedicated to epidemiological study.

```{r}
# renv::install("cleanepi")
# renv::install("epiparameter")
# renv::install("epiparameterDB")
# renv::install("cfr")
